...
coord_t NaiveBeadingStrategy::optimalThickness(coord_t bead_count) const
{
    return bead_count * optimal_width;
}

coord_t NaiveBeadingStrategy::transitionThickness(coord_t lower_bead_count) const
{
...
coord_t NaiveBeadingStrategy::optimalBeadCount(coord_t thickness) const
{
