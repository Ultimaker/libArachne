...
coord_t CenterDeviationBeadingStrategy::optimalThickness(coord_t bead_count) const
{
    return bead_count * optimal_width;
}

coord_t CenterDeviationBeadingStrategy::transitionThickness(coord_t lower_bead_count) const
{
...
coord_t CenterDeviationBeadingStrategy::optimalBeadCount(coord_t thickness) const
{
