...
coord_t SingleBeadBeadingStrategy::optimalThickness(coord_t bead_count) const
{
    return bead_count * optimal_width - 10;
}

coord_t SingleBeadBeadingStrategy::transitionThickness(coord_t lower_bead_count) const
{
...
coord_t SingleBeadBeadingStrategy::optimalBeadCount(coord_t thickness) const
{
