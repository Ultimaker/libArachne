...
{
template <>
struct hash<arachne::ClosestPolygonPoint>
{
    size_t operator()(const arachne::ClosestPolygonPoint& cpp) const
    {
        return std::hash<arachne::Point>()(cpp.p());
    }
};
}//namespace std
...
public:
    ...
    */
     ...
     * 
     * This implementation uses a sparse grid to get to an acarachnete result quickly
     * 
